import allure
import pytest
import logging  # This is used to print the messages - Logs
#logging is already by default installed in Python
...
class TestCreateBooking(object):
    ...
    def test_create_booking_positive(self):
        ...
        response = post_request(
            url=APIConstants().url_create_booking(), #APIConstants() -> obj of APIConstants class
            auth=None,
            headers=Utils().common_headers_json(), #Utils() -> obj of Utils class
